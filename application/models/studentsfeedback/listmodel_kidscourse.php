...
class ListModel_KidsCourse extends CI_Model {
    ...
    public function getInterviews($limit, $offset) {
            ...
            $this->db->where('course_type',KIDSCOURSEID);
    ...
    public function recordCount(){
        return $this->db->select('student_name')->where('course_type',KIDSCOURSEID)->from("student_interview")->count_all_results();
    }
