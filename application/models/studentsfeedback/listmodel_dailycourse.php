...
class ListModel_DailyCourse extends CI_Model {
    ...
    public function getInterviews($limit, $offset) {
        ...
        $course_not_included = array(KIDSCOURSEID,BUSINESSENGID,TRAVELENGID,PRONUNID,CALLANID,NEWSALERTID,INTERCHANGEID,IELTSID,FIRSTTIMEID);
